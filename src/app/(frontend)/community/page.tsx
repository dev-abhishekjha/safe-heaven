...
import { ScreenCommunity } from '@/screens/Community/ScreenCommunity';
import { getCommunityContent } from '@/services/pageContentService';
import type { Metadata } from 'next';

export const metadata: Metadata = {
	title: 'Community',
	description:
		'The Safe Haven WhatsApp community — internships, senior advice, swaps and campus notices shared by students living in Greater Noida.',
	...
	return (
		<>
			<BreadcrumbStructuredData
				crumbs={[{ name: 'Community', path: '/community' }]}
			/>
			<ScreenCommunity content={content} />
		</>
	);
}
